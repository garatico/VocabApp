...
def merge_duplicate_words(entries: List[dict]) -> List[dict]:
    """
    Merge entries sharing the same word (e.g. 'sí' as pronoun + adverb).
...
def main(langs: List[str], n: int, verbose: bool,
         ...
         corpus: str = 'wikipedia', os_min_count: int = 500) -> None:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help='Top-N corpus words per language (default: 10000; 0 = hardcoded only)'
    )
    parser.add_argument(
